...
void setup() {
  ...
  calibrationValue = -23058.59; // uncomment this if you want to set the calibration value in the sketch
...
void loop() {
  ...
  const int serialPrintInterval = 2500; //increase value to slow down serial print activity
