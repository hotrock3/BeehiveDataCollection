...
//Wifi Details 
const char* ssid     = "Keystone-Guest";    // Type your network SSID (name)
const char* password = "dingshi2014"; // Type your network password
# define WiFiTimeOutMS 60000        // value typed = seconds * 1000

//MQTT Detailes  MUST SET IP ADDRESS FOR MQTT
const char* mqtt_server = "10.254.14.11";  //update to be Pi server's IP address. Keystone Guest = 10.254.14.11
